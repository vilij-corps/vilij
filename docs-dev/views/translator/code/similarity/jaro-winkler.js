 ...
 */
var similarity_jaro_winkler = function() {
/**
 ...
 */
function jaroWinkler(options, a, b) {
  options = options || {};
  ...
  const dj = H.Talisman.Jaro.exec(a, b);
 ...
 */
var distance = function(options, a, b) {
  const result = 1 - jaroWinkler(options, a, b);
  return result;
}

var similarity = function(options, a, b) {
  const result = jaroWinkler(options, a, b);
  return result;
}
