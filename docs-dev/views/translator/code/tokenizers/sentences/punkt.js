 ...
 */
var yokenize_sentences_punkt = function() {
 ...
 */
class PunktTrainer extends PunktBaseClass {
  constructor(options) {
    const {
      verbose = false
    } = options || {};
 ...
 */
 class PunktSentenceTokenizer {
  ...
  _slicesFromText(text) {
    const slices = [],
          matches = H.Talisman.Helpers.findall(this.vars.rePeriodContext, text);
